...
public class ItemServlet extends HttpServlet {
    ...
    public ItemServlet(Connect data) {
        this.data = data;
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<String> collumns = new ArrayList<>(Requests.ITEM.collumns());
        List<Object> values = values(request);
        Requests.cutNullValues(collumns, values);
        ResultSet rs = null;

        try {
            rs = data.getResultSet(Requests.read(Requests.ITEM.tableName(), collumns, values));
        ...
        String ans = "";
        try {
            ans = FormirateAnswer.answer(Requests.ITEM.collumns(), rs);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            data.update(Requests.insert(Requests.ITEM.tableName(), collumns, values));
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            data.update(Requests.remove(Requests.ITEM.tableName(), collumns, values));
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws IOException {
        List<String> collumns1 = new ArrayList<>(Requests.ITEM.collumns());
        List<Object> values1 = values(request);
        Requests.cutNullValues(collumns1, values1);

        List<String> collumns2 = new ArrayList<>(Requests.ITEM.collumns());
        List<Object> values2 = values(request, "C");
        Requests.cutNullValues(collumns2, values2);


        try {
            data.update(Requests.update(Requests.ITEM.tableName(), collumns2, values2, collumns1, values1));
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    protected List<Object> values(HttpServletRequest request, String s){
        ...
        v = request.getParameter(s+"level");
        values.add(v);
